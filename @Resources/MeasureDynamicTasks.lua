...
function Update()
    ...
    for i=1,#tasks,1 do
        ...
        dynamicOutput[#dynamicOutput + 1] = "Shape2=Rectangle -#CornerRadius#,0,(#Width# - [MeterTaskIcon"..i..":W]),([MeterRepeatingTask"..i..":H]),0"
        dynamicOutput[#dynamicOutput + 1] = "Shape3=Rectangle (-#CornerRadius# * 2),0,(#CornerRadius# * 2),([MeterRepeatingTask"..i..":H]),#CornerRadius#"
